...
public class HostileBoar : MonoBehaviour
{
	...
	private float attackCooldown = 2f; // 공격 쿨다운 시간
	private float lastAttackTime; // 마지막 공격 시간

	private float health = 100f; // 멧돼지의 체력
	...
	public float chaseSpeed = 4.0f; // 추격 속도
	...
	void Start()
	{
		...
		healthSlider.maxValue = 100; // 슬라이더의 최대값을 100으로 설정
	...
	{
		healthPanel.SetActive(health < 100);
	...
	void Die()
	{
		...
		//Destroy(gameObject, 2f); // 사망 애니메이션이 2초라고 가정
