...
public class HostileWolf : MonoBehaviour
{
	...
	public float chaseSpeed = 6.0f; // 추격 속도
	...
	void Start()
	{
		...
		healthSlider.maxValue = 70; // 슬라이더의 최대값을 70으로 설정
	...
	{
		healthPanel.SetActive(health < 70);
